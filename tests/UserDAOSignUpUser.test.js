...
test('Checks duplicate users cannot be inserted into the database', async () =>{
    await dao.signUp("test1", "Test!123", "Test!123", "test", "von test", "test1@test.com");
    expect(await dao.signUp("test1", "Test!123", "Test!123", "test", "von test", "test1@test.com")).toBe(false);
})*/
